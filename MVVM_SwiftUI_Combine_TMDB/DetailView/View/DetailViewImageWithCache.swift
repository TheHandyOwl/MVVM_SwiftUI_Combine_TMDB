//
//  DetailViewImageWithCache.swift
...
struct DetailViewImageWithCache: View {
...
struct DetailViewImageWithCache_Previews: PreviewProvider {
    static var previews: some View {
        DetailViewImageWithCache(imageString: Constants.Strings.previewImage)
    }
}
